...
challengeSchema.methods.findChallenge = function <ChallengeDocument>(query: string): Promise<ChallengeDocument> {
  return this.find(query);
};

challengeSchema.methods.updateChallenge = function <ChallengeDocument>(
  _id: string,
  document
...
export default model<ChallengeDocument, challengeModel>('challenge', challengeSchema);
